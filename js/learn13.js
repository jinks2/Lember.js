...
App.ReviewView = Em.View.extend({  
  isExpanded: false,
  classNameBindings: ["isExpanded","readMore"],
  click: function() {
  this.toggleProperty("isExpanded");
 },
 readMore:Em.computed.gt("length",140) // instead of last
});
...
//create helper
Em.Handlebars.registerBoundHelper("markdown",function(text) {
  return text;
  //return new Handlebars.SafeString(markdown.toHTML(text));markdown is a external lib
})
